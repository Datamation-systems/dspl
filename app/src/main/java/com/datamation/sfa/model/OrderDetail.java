...
public class OrderDetail {
    ...
    private String ORDDET_PRILCODE;
    ...
    public String getORDDET_PRILCODE() {
        return ORDDET_PRILCODE;
    }

    public void setORDDET_PRILCODE(String ORDDET_PRILCODE) {
        this.ORDDET_PRILCODE = ORDDET_PRILCODE;
    }
    ...
    public JSONObject getOrderDetailAsJSON(Order order) {
        ...
        params.put("prilcode", ORDDET_PRILCODE);
