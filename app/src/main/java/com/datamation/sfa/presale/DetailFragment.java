        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MaterialDialog materialDialog = new MaterialDialog.Builder(getActivity())
                        .content("Do you want to save order details?")
            ...
            protected Void doInBackground(Void... params) {
                ...
                for (tempOrderDet product : list) {
                   ...
                   // String prilCode, String itemCode, String Qty, String price, String itemname
                    mUpdatePrsSales(product.getPREPRODUCT_PRILCODE(), product.getPREPRODUCT_ITEMCODE(), product.getPREPRODUCT_QTY(), product.getPREPRODUCT_PRICE(),product.getPREPRODUCT_ITEMNAME());
                }
                return null;
            }
...
/*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*/
    ...
    public void mUpdatePrsSales(String prilCode, String itemCode, String Qty, String price, String itemname) {
        ...
        SODet.setORDDET_PRILCODE(prilCode + "");
