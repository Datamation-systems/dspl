...
public class HistoryDetailsFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ArrayList<Last3Invoice> last3InvList =  new FInvhedL3Controller(getActivity()).getLast3InvoiceDetails();
        ArrayList<FInvhedL3> FInvhedL3ArrayList = new FInvhedL3Controller(getActivity()).getLast3InvoiceHed();
